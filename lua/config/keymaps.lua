...
-- { "<leader>kkK", "<cmd>terminal k9s<CR>", desc = "Open K9s" },
...
-- local terminal_utils_mapping = {
--   { "<leader>t", group = "Terminal" }, -- Main title for all Terminal related commands
--   { "<leader>tk", ":tabnew | terminal k9s<CR>", desc = "Open Terminal with K9s in New Tab" },
--   { "<leader>tt", ":tabnew | terminal<CR>", desc = "Open Terminal in New Tab" },
-- }
--
-- require("which-key").add(terminal_utils_mapping)
